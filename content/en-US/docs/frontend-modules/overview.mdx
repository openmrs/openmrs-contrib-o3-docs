...
- ESLint 9 and `@openmrs/eslint-config` are dev dependencies. Shared rules and repository-specific ignores live in the root `eslint.config.mjs`; see [Linting](/docs/frontend-modules/development#linting).
