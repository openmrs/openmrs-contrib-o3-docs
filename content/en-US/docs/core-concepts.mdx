...
own module, scaffold it with [`@openmrs/create-o3-app`](https://www.npmjs.com/package/@openmrs/create-o3-app), publish it
to npm under your own namespace, then add an entry for it in `spa-assemble-config.json`. The
[template app repo](https://github.com/openmrs/openmrs-esm-template-app) remains useful as a reference or manual fallback.
