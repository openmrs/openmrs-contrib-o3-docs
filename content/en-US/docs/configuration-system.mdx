...
- `Type.Object` - Freeform object values. When used with `_elements`, O3 validates and fills defaults for each value in the object.
...
For convenience, some common validators are provided out of the box, including [`inRange`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/inRange.md), [`oneOf`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/oneOf.md), and [`isUrlWithTemplateParameters`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/isUrlWithTemplateParameters.md).
...
1. **Extension's base configuration** - Values provided under the extension name when the extension has its own schema, or under the extension module name when it uses the module schema
...
Some common validators are provided, including [`inRange`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/inRange.md), [`oneOf`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/oneOf.md), and [`isUrlWithTemplateParameters`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/isUrlWithTemplateParameters.md).

Custom validators should be created with the [`validator`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/validator.md) function.
...
See the generated API docs for [`defineConfigSchema`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/defineConfigSchema.md), [`defineExtensionConfigSchema`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/defineExtensionConfigSchema.md), [`getConfig`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/getConfig.md), [`useConfig`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/useConfig.md), and [`validator`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/validator.md).
