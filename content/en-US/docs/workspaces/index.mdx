...
The older v1 APIs (`workspaces`, `launchWorkspace`, `ActionMenuButton`, workspace `type`, `canHide`, and `promptBeforeClosing`) are deprecated. See [Migrating to Workspace v2](/docs/migrate-to-workspace-v2) when updating older code.
