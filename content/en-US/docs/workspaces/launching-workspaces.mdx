...
2. If another group is open, or if the existing group props are incompatible, O3 prompts before closing the current group and its windows.
...
4. If the target window or workspace has incompatible props, O3 prompts before closing the window and opening a fresh instance.
