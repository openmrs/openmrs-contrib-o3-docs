...
<Callout type="info">
  ...
  [Migrating to Rspack and Vitest](/docs/migrate-to-rspack-and-vitest). For new modules, start with
...
After completing this Core v6 migration, continue with [Migrating to Rspack and Vitest](/docs/migrate-to-rspack-and-vitest) unless your repository has already completed that work.
