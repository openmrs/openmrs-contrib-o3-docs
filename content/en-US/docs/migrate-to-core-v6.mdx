...
<Callout type="info">
  ...
  `@openmrs/create-o3-app` generator.
</Callout>
...
- **New modules** should start from [`@openmrs/create-o3-app`](/docs/recipes/create-a-frontend-module), which scaffolds the current Rspack and Vitest setup.
