...
and runtime; a map can be valid while a referenced key is missing.
...
Intent handling mutates a refined copy of the form before rendering. Test every supported intent and its fallback; another
renderer can handle the same intent differently.
