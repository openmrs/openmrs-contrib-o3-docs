...
2. **Config files** (from `configUrls`, loaded sequentially): this includes manually extracted content package frontend configs once their URL is added to `configUrls`; later files in the array override earlier files
