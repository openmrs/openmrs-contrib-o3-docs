...
**Properties**:
- `id` - Unique identifier for this element (required). This must match the ward card component's `id`; the built-in maternal ward cards use `pregnancy-complications`.
