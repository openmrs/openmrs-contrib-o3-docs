...
`@openmrs/esm-framework`. See the [Framework API reference](/docs/framework-api-reference).

## FHIR

To use the FHIR API in React components, prefer `useOpenmrsSWR` from `@openmrs/esm-framework`. It wraps [SWR](https://swr.vercel.app/docs/data-fetching), calls [`openmrsFetch`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/openmrsFetch.md), and attaches an abort controller so the request can be cancelled if the component unmounts.
...
in a [`useEffect` hook](https://react.dev/reference/react/useEffect):
...
See for example [`useVisitTypes`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/useVisitTypes.md)
and the corresponding [`getVisitTypes`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/getVisitTypes.md).
