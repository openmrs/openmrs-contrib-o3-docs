...
Navigate to `http://localhost:8080/openmrs` in your browser. You should expect the see the backend getting set up. Once that completes, you can navigate to `http://localhost:8080/openmrs/spa`.
