...
using a browser, navigating to `localhost/openmrs` should redirect you to the initial setup page at `localhost/openmrs/initialsetup`. This setup will take a few minutes to complete. Once it's done, you should be able to launch O3 by visiting `http://localhost/openmrs` in your browser. If you're not using a browser, you can curl the URL to check whether the setup is complete. Run the following command in your terminal to do this:
