...
- Specialized components use purpose-specific suffixes instead of the base `.component` suffix. They include:
  - `.extension` for components that render extensions e.g. [lab-order-basket-panel.extension.tsx](https://github.com/openmrs/openmrs-esm-patient-chart/blob/main/packages/esm-patient-tests-app/src/test-orders/lab-order-basket-panel/lab-order-basket-panel.extension.tsx) for the `Lab Order Basket panel` extension.
