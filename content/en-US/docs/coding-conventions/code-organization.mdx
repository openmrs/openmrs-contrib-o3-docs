...
- Use [`@openmrs/create-o3-app`](https://www.npmjs.com/package/@openmrs/create-o3-app) to quickly seed new O3 frontend modules:
  ...
  The [template app](https://github.com/openmrs/openmrs-esm-template-app) remains useful as a reference or manual fallback.
