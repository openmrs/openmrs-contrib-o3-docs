...
1. [Factoriser les métadonnées statiques dans un fichier `routes.json`](/docs/migration-guides/migrate-to-core-v5#factor-out-static-metadata)
2. [Factoriser les métadonnées dynamiques dans une fonction activatrice `startupApp`](/docs/migration-guides/migrate-to-core-v5#factor-out-dynamic-metadata)
3. [Mettre à jour les dépendances de base](/docs/migration-guides/migrate-to-core-v5#upgrade-core-dependencies)
4. [Consulter le guide de dépannage](/docs/migration-guides/migrate-to-core-v5#troubleshooting)
