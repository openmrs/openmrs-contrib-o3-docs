...
Webpack Module Federation sur `window`, avec le nom du module transformé en identifiant JavaScript. L'app shell appelle
ensuite les fonctions `init` et `get` du conteneur pour charger l'export `./start` du module.
