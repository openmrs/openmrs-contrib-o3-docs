...
<Callout type="info">
  ...
  modules, commencez par [Créer un module frontend](/docs/recipes/create-a-frontend-module), qui utilise le générateur
  publié `@openmrs/create-o3-app`.
</Callout>
...
- **Les nouveaux modules** devraient démarrer avec [`@openmrs/create-o3-app`](/docs/recipes/create-a-frontend-module), qui génère la configuration Rspack et Vitest actuelle.
