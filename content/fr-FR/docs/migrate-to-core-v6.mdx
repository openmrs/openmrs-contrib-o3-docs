...
<Callout type="info">
  ...
  Rspack et Vitest, poursuivez avec [Migrer vers Rspack et Vitest](/docs/migrate-to-rspack-and-vitest). Pour de nouveaux
...
Après cette migration Core v6, continuez avec [Migration vers Rspack et Vitest](/docs/migrate-to-rspack-and-vitest), sauf si votre dépôt a déjà terminé ce travail.
