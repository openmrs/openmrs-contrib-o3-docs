...
Pour utiliser le système de modales, votre application doit d'abord enregistrer la modale comme décrit ci-dessous. Une fois la modale enregistrée, appelez [`showModal`](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-framework/docs/functions/showModal.md) avec le nom de la modale, et le framework l'affichera pour vous.
