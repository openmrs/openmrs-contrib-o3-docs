...
- Utilisez [`@openmrs/create-o3-app`](https://www.npmjs.com/package/@openmrs/create-o3-app) pour créer rapidement de nouveaux modules frontend O3 :

  ```sh
  npm exec @openmrs/create-o3-app@latest -- my-module --standalone
  ```
  ...
  L'[application template](https://github.com/openmrs/openmrs-esm-template-app) reste utile comme référence ou solution manuelle.
