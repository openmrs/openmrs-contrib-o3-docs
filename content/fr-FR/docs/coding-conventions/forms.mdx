...
- Utilisez [React Hook Form](https://react-hook-form.com/) avec [Zod](https://zod.dev/) pour la validation des formulaires, en ajoutant d'abord `react-hook-form`, `@hookform/resolvers` et `zod` aux dépendances du package si le module ne les déclare pas déjà. Cette combinaison offre une validation type-safe et d'excellentes performances :
  ...
  const formSchema = z.object({
    ...
    password: z.string().min(8, t('passwordTooShort', 'Le mot de passe doit contenir au moins 8 caractères')),
