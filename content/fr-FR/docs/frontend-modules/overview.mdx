...
- ESLint 9 et `@openmrs/eslint-config` sont des dev dependencies. Les règles partagées et les exclusions propres au dépôt se trouvent dans le fichier racine `eslint.config.mjs`; consultez la section [Linting](/docs/frontend-modules/development#linting).
