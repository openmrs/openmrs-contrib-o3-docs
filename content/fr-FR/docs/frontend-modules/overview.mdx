...
<Callout type="info">
  Si vous créez un nouveau module plutôt que de comprendre un module existant, commencez par la recette [Création d'un module frontend](/docs/recipes/create-a-frontend-module). Cette vue d'ensemble explique les pièces en jeu; la recette décrit les flux avec `create-o3-app` et l'application template.
</Callout>
