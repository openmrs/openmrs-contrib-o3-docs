...
La configuration minimale générée par `npm create @openmrs/o3-app@latest` charge la configuration standard depuis `@openmrs/rspack-config`:
...
Cette configuration délègue tout aux valeurs par défaut décrites ci-dessous.
