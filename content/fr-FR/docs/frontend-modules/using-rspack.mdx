...
- Lorsque vous êtes prêt à basculer, consultez [Migration vers Rspack et Vitest](/docs/migration-guides/migrate-to-rspack-and-vitest). Le remplacement de configuration est mécanique.
