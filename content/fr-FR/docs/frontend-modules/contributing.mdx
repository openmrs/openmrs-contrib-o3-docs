...
- **Garder votre branche de PR à jour** - Si votre PR reste ouverte longtemps, vous devrez peut-être la rebaser sur la branche principale pour la garder à jour. Cela garantit que le code est relu par rapport aux derniers changements.
