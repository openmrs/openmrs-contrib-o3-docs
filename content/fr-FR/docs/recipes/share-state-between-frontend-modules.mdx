...
Utilisez le hook [`useState`](https://react.dev/reference/react/useState) (ou
[`useReducer`](https://react.dev/reference/react/useReducer))
et [Context](https://react.dev/learn/passing-data-deeply-with-context) pour faire circuler l'état au sein de votre
module frontal.

Dans certains cas, vous pouvez avoir besoin de gérer l'état en dehors de React,
par exemple lorsque vous avez des applications React séparées qui doivent partager l'état.
...
Voir la [documentation Zustand](https://docs.pmnd.rs/zustand/getting-started/introduction) pour plus d'informations sur les stores.
