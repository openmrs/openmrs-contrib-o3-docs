...
`scopePattern` est une expression régulière comparée à l'URL courante. S'il est omis, le groupe ne se ferme que lors de la navigation vers une autre app. S'il est défini, O3 ferme le groupe lorsque la nouvelle URL ne correspond plus au pattern ; si le pattern contient des groupes de capture, O3 ferme aussi le groupe lorsque les valeurs capturées changent. Ancrez le pattern avec `^` afin qu'il ne corresponde qu'au préfixe de route prévu.
