...
Le nom de l'extension doit correspondre à la propriété `name` de l'extension telle que définie dans `routes.json`. Lorsqu'une extension a son propre schéma de configuration, `useConfig()` dans cette extension fusionne la configuration normale du module avec la configuration de l'extension. Les valeurs spécifiques à l'extension ont la priorité lorsque la même clé existe aux deux endroits.
