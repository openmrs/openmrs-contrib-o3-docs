...
2. **Fichiers de configuration** (depuis `configUrls`, chargés séquentiellement) : cela inclut les configurations frontend des packages de contenu extraites manuellement une fois leur URL ajoutée à `configUrls` ; les fichiers plus tardifs dans le tableau remplacent les fichiers antérieurs
