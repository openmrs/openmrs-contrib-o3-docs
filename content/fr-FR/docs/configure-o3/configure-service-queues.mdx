...
- `config` - Configuration spécifique à la colonne :
  ...
  - Pour `extension` : une colonne avec l'ID `eligibility` rend l'emplacement d'extension `queue-table-eligibility-slot` et transmet `queueEntry` dans l'état de l'emplacement
