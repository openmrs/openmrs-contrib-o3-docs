...
Les clés de traduction et les propriétés JSON sont des identifiants; ne les traduisez pas. Testez chaque locale dans l'aperçu du constructeur et à l'exécution, car une map valide ne prouve pas que chaque clé référencée existe.
...
Le traitement de l'intention modifie une copie affinée du formulaire avant le rendu. Testez chaque intention et son repli; le schéma normatif ne garantit aucun comportement équivalent dans un autre renderer.
